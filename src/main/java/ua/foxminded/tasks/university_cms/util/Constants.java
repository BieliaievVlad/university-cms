...
public class Constants {
	...
	public static final Path UPDATE_GROUPS = Paths.get("sql", "testDataGeneration",
													   "update_groups_table.sql");
	public static final Path GENERATE_TEACHERS = Paths.get("sql", "testDataGeneration",
			"generate_teachers.sql");
	public static final Path GENERATE_TEACHERS_COURSES = Paths.get("sql", "testDataGeneration",
			"generate_teachers_courses.sql");
	public static final Path GENERATE_SCHEDULE = Paths.get("sql", "testDataGeneration",
			"generate_schedule.sql");
